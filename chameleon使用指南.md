...
https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/tools/chameleon-5.1.1-py3-none-any.whl

其中5.1.1表示当前版本号，其可以通过chameleon --version命令查询。
...
**pip3 install ./chameleon-5.1.1-py3-none-any.whl**
...
| 系统名称       | 系统架构 | 下载链接                                                     |
| :------------- | -------- | ------------------------------------------------------------ |
| centos7        | x86_64   | https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/tools/centos7/chameleon-5.1.1-x86_64.tar.gz |
| openEuler20.03 | x86_64   | https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/tools/openEuler20.03/chameleon-5.1.1-x86_64.tar.gz |
| openEuler20.03 | aarch64  | https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/tools/openEuler20.03/chameleon-5.1.1-aarch64.tar.gz |
| openEuler22.03 | x86_64   | https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/tools/openEuler22.03/chameleon-5.1.1-x86_64.tar.gz |
| openEuler22.03 | aarch64  | https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/tools/openEuler22.03/chameleon-5.1.1-aarch64.tar.gz |

下载完成后，使用tar -zxvf 命令进行解压

```
tar -zxvf chameleon-5.1.1-x86_64.tar.gz
```
